...
extension UIAlertController {
    ...
    enum Factory {
        ...
        static func createCategoryAlert(name: [String], completion: @escaping (String) -> Void) -> UIAlertController {
        ...
        static func createIngredientController(completion: @escaping (String?) -> Void) -> UIAlertController {
        ...
        static func basketCreateAlert(completion: @escaping () -> Void) -> UIAlertController {
